<template>
    <div class="d-flex h-screen overflow-hidden relative">
      ...
      >
        ...
        >
          ...
          >
          <div class="mt-4"></div>
          <button @click="router.push('/')" type="button" class="text-h7 text-red">old user ?</button>
  ...
  const confirmPasswordRule = [
    (value:string)=> password.value ===confirmPassword.value?true:"Password and Confirm password does not match!"
  ]
  const passwordRule = [
